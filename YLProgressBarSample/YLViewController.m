...
- (void)initRoundedSlimProgressBar
{
    ...
    _progressBarRoundedSlim.trackTintColor           = [UIColor lightGrayColor];
    _progressBarRoundedSlim.indicatorTextDisplayMode = YLProgressBarIndicatorTextDisplayModeNone;
    _progressBarRoundedSlim.hideStripes        = YES;
}

- (void)initRoundedFatProgressBar
{
    _progressBarRoundedFat.progressTintColor        = [UIColor redColor];
    _progressBarRoundedFat.trackTintColor           = [UIColor lightGrayColor];
    _progressBarRoundedFat.indicatorTextDisplayMode = YLProgressBarIndicatorTextDisplayModeNone;
    _progressBarRoundedFat.hideStripes        = YES;
}
